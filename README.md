...
<head>
  ...
  <title>PUBG Tournament Uzbekistan</title>
...
<nav>
  <ul>
    ...
    <li><a href="#tournament">Turnir</a></li>
    <li><a href="#register">Ro‘yxatdan</a></li>
    <li><a href="#rules">Qoidalar</a></li>
    <li><a href="#admin" onclick="openAdmin()">Admin</a></li>
  </ul>
</nav>

<!-- HOME -->
<section id="home">
  <h1>PUBG MOBILE TOURNAMENT UZBEKISTAN</h1>
  <p>Eng katta turnir platformasi</p>
</section>
...
<section id="register">
  ...
  <form onsubmit="submitForm(event)">
    ...
    <input id="player" type="text" placeholder="Player ID" required>
    <input id="tg" type="text" placeholder="Telegram username" required>
...
<section id="rules">
  <h2>Qoidalar</h2>
  <p>❌ Cheat taqiqlanadi</p>
  <p>🤝 Respect shart</p>
  <p>⛔ Admin qarori yakuniy</p>
</section>
...
<script>
  ...
  function showData(){
    ...
    if(submissions.length === 0){
      box.innerHTML = "<p>Hech narsa yo‘q</p>";
      return;
    }
...
<li><a href="#" onclick="openAdmin(event)">Admin</a></li>
...
<head>
  <meta charset="UTF-8">
  <title>PUBG MOBILE TOURNAMENT UZBEKISTAN</title>
  <style
  <!DOCTYPE html>
<html lang="uz">
<head>
